...
const ShipinhaoImageTextCard: React.FC<CardProps> = ({ loading, scenario: _scenario, onConfigure, isZh }) => {
  return (
...
const ShipinhaoReplyFansCard: React.FC<CardProps> = ({ loading, scenario: _scenario, onConfigure, isZh }) => {
  return (
