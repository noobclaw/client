          ...
          {step === 2 && (
            <>
              ...
              <RangeSlider
                ...
                hardCap={COMMENT_HARDCAP} hint={isZh ? `每次随机发 ${cmtMin}-${cmtMax} 条评论 (1-${COMMENT_HARDCAP},内容由 AI 按下方提示词生成,语言会自动匹配视频与评论区)` : `Random ${cmtMin}-${cmtMax} comments (1-${COMMENT_HARDCAP}, AI writes from prompt below; language auto-matches video & comments)`}
                disabled={saving}
              />
