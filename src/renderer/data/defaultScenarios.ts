...
export const DEFAULT_SCENARIOS: Scenario[] = ([
  ...
  },
  {
    ...
    "workflow_type": "video_repost_remix",
    "category": "creation",
    "name_zh": "视频搬运 · 二创",
    "name_en": "Video Repost · Remix",
    "description_zh": "自动选品(按赛道+关键词去抖音/快手/B站/小红书/TikTok 找视频)或手动粘贴链接,本地浏览器取无水印源视频 → 本地 whisper 语音转写识别语言 → 按需翻译字幕/配音 → 遮盖原硬字幕并覆盖新字幕 → 原创度增强(变速/裁剪/调色)→ 合成存本地。发前可查目标平台是否已被搬运。全程本地 ffmpeg,免费。",
    "description_en": "Auto-discover videos by track+keywords across Douyin/Kuaishou/Bilibili/XHS/TikTok (or paste links), grab the watermark-free source via the local browser, transcribe with local whisper to detect language, optionally translate subtitles/dub, cover burned-in subtitles and overlay new ones, boost originality (speed/crop/color), then compose and save locally. Optional saturation check on the target platform before publishing.",
    "icon": "🎬",
    "default_config": {
      "source_mode": "auto",
      "source_platforms": [
    ...
    "skills": {
      "scripts": {},
      "prompts": {
        "translate_subtitle": "prompts/translate_subtitle.txt",
        "caption_rewrite": "prompts/caption_rewrite.txt"
      },
      "config": "config.json",
      "orchestrator": "orchestrator.js"
    }
